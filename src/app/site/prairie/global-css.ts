...
export function set_global_css() {
    ...
    gcss.media(BP_TABLET).sel("div#page-host").setMany({
        gridTemplateColumns: "1fr",
        gridTemplateRows: "auto minmax(0, 1fr)",
    });
    gcss.media(BP_TABLET).sel("div#menu-panel").setMany({
        gridRow: "1",
        gridTemplateColumns: "1fr 1fr 1fr"
    });

    gcss.media(BP_TABLET).sel("div#content-panel").setMany({
        gridRow: "2",
    });

    gcss.media(BP_TABLET).sel("div#menu-box").setMany({
    ...
    gcss.media(BP_TABLET).sel("div#content-panel .content.box").setMany({
    ...
    gcss.media(BP_PHONE).sel("div#page-host").setMany({
        gridTemplateRows: "auto minmax(0, 1fr)",
    });
